...
Although the multinomial logistic regression results predicted yearsmarried, religiousness, and happiness rating as significant factors of marital infidelity, its accuracy at predicting was rather low. Only 1 out 3 predictions was correct. Does this imply we ought to discard the model? Not entirely. Predicting human behavior is a complex model with a lot more factors than yearsmarried, religiousness, and happiness rating. More research is needed for the model. 
